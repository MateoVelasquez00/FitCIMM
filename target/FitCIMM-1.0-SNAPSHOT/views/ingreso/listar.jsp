...
<div class="container my-4">
    <% if (mensaje != null) {%>
    <div class="alert alert-<%= "danger".equals(tipoMensaje) ? "danger" : ("success".equals(tipoMensaje) ? "success" : "info")%> alert-dismissible fade show" role="alert">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-8">
            <h2 class="fw-bold"><i class="bi bi-door-open text-danger"></i> Registro de Ingresos</h2>
            <p class="text-muted mb-0">Historial de accesos marcados en el gimnasio</p>
        </div>
        <div class="col-md-4 text-md-end mt-3 mt-md-0">
            <a href="<%= request.getContextPath()%>/views/ingreso/crear.jsp" class="btn btn-danger text-white fw-bold shadow-sm">
    ...
    <div class="row mb-3">
        <div class="col-12 text-end">
            <span class="text-muted">Total Registros: <strong class="badge bg-secondary"><%= listaIngresos != null ? listaIngresos.size() : 0%></strong></span>
        </div>
    </div>

    <div class="card shadow-sm border-0">
        <div class="card-header bg-dark text-white fw-bold">
            <i class="bi bi-list-check me-2"></i> Historial de Accesos al Gimnasio
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            <th scope="col" class="ps-3">Socio / Documento</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <small class="text-dark fw-semibold">
                                    <i class="bi bi-calendar3 me-1 text-primary"></i><%= ing.getFechaIngreso()%>
                                </small>
                            </td>
                            <td class="text-center">
